...
namespace OnlinePizzaWebApplication.Repositories
{
    public class PizzaRepository : IPizzaRepository
    {
        ...
        public IEnumerable<Pizzas> Pizzas => throw new NotImplementedException();
        ...
        {
            return await _context.Pizzas.Include(p => p.Category).ToListAsync();
        }
        ...
        {
            return await _context.Pizzas.Include(p => p.Category).FirstOrDefaultAsync(p => p.Id == id);
        }
